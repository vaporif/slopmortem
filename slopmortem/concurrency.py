...
want the opposite contract: a single failed candidate must not cancel its
siblings. :func:`gather_resilient` wraps the one asyncio primitive that gives
that contract so the rest of the code only has to import this helper.
"""
