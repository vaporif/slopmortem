...
def test_query_smoke_renders_report(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("slopmortem.cli._app._build_deps", _build_fake_deps)
    monkeypatch.setattr("slopmortem.cli._app.set_query_corpus", _noop_set_corpus)
    monkeypatch.setattr("slopmortem.cli._app.run_query", _fake_run_query)
